...
const CGDistricts = () => {
  ...
  const districtsData = [
    ...
    { name: 'Dakshin Bastar Dantewara', waterBodies: 16 },
    { name: 'Dhamtari', waterBodies: 9 },
    { name: 'Durg', waterBodies: 11 },
    { name: 'Gariyaband', waterBodies: 6 },
    { name: 'Gaurela Pendra Marwahi', waterBodies: 6 },
    { name: 'Janjgir Champa', waterBodies: 13 },
    { name: 'Jashpur', waterBodies: 10 },
    { name: 'Kawardha', waterBodies: 13 },
    { name: 'Khairgarh Chhuikhadan Gandai', waterBodies: 13 },
    { name: 'Kondagaon', waterBodies: 12 },
    { name: 'Korba', waterBodies: 15 },
    { name: 'Koreya', waterBodies: 9 },
    { name: 'Mahasamund', waterBodies: 7 },
    { name: 'Manendragarh Chirmiri Bharatpur', waterBodies: 7 },
    { name: 'Mohla Manpur Ambargarh Chowki', waterBodies: 7 },
    ...
    { name: 'Sakti', waterBodies: 13 },
    { name: 'Sarangarh Bilaigarh', waterBodies: 13 },
    { name: 'Sukma', waterBodies: 13 },
    { name: 'Surajpur', waterBodies: 8 },
    { name: 'Surguja', waterBodies: 19 },
    { name: 'Uttar Bastar Kanker', waterBodies: 19 }
  ];
